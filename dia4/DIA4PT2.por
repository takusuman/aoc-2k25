...
// Professor   : Eu mesmo
// Descrição   : Dia 4, parte II do Advent of Code...
...
//
// Segunda parte:
// "Once a roll of paper can be accessed by a
// forklift, it can be removed. Once a roll of
// paper is removed, the forklifts might be
// able to access more rolls of paper, which
// they might also be able to remove."
